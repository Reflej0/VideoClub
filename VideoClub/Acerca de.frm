...
Begin VB.Form Acercade 
   ...
   Begin VB.Label lblTitle 
      Caption         =   "Título de la aplicación: Sistema de VideoClub            by Tocino"
      ForeColor       =   &H00000000&
      Height          =   480
      Left            =   1800
      TabIndex        =   5
   ...
   Begin VB.Label lblDisclaimer 
      Caption         =   "Advertencia: Este programa está protegido por leyes de derechos de marca y propiedad intelectual. "
      ForeColor       =   &H00000000&
      Height          =   825
      Left            =   240
      TabIndex        =   4
